...
public class TicTacToeModel {
    ...
    private int doOptimalMove() {
        if (gameField[1][1] == EMPTY) {
            ...
            if(gameField[0][0] == CROSS && gameField[2][2] == CROSS && gameField[0][1] == EMPTY){
                gameField[1][0] = NOUGHT;
                return 0;
            }
            if(gameField[2][0] == CROSS && gameField[0][2] == CROSS && gameField[1][0] == EMPTY){
                gameField[1][0] = NOUGHT;
                return 0;
            }
            if(gameField[1][0] == CROSS && gameField[0][1] == CROSS && gameField[0][0] == EMPTY){
                gameField[0][0] = NOUGHT;
                return 0;
            }
            if(gameField[0][1] == CROSS && gameField[1][2] == CROSS && gameField[0][2] == EMPTY){
                gameField[0][2] = NOUGHT;
                return 0;
            }
            if(gameField[1][2] == CROSS && gameField[2][1] == CROSS && gameField[2][2] == EMPTY){
                gameField[2][2] = NOUGHT;
                return 0;
            }
            if(gameField[2][1] == CROSS && gameField[1][0] == CROSS && gameField[2][0] == EMPTY){
                gameField[2][0] = NOUGHT;
                return 0;
            }
